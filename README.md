# Reveal + MySql E2E for PoC Kickoff
...
- **Data Sources**: Registers the MySql connector, which is necessary for MySql integrations in .NET Core.  For NodeJS, you are not required to install / register the MySql SQL connector separately.
...
Explore these video resources to help you set up and configure Reveal BI for .NET and SQL Server, just change the type to Mysql in each function to map to MySql:
