...
module.exports = (app) => {
     ...
     * /api:
     *   get:
     *     summary: API Overview Page
     *     description: Displays an overview of available API endpoints with links to Swagger documentation.
     *     tags:
     *       - Documentation
     *     responses:
     *       200:
     *         description: HTML page with API overview
     */
    app.get('/api', (req, res) => {
        res.sendFile(path.join(__dirname, '../Client/index-swagger.html'));
    });
